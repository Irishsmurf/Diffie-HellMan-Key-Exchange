 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: pfsamp.c,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1994/05/20 15:55:44 $";
#endif
 ...
 *
 * To compile:  cc pfsamp.c -o pfsamp
 *
 * Example:     pfsamp
 *
 ...
 *              The pfopen function is available in libc.a on DEC OSF/1 V2.0
 *              and later systems.  See the pfopen(3) reference page for more
 *              information.
 */
...
#include <stdio.h>
#include </usr/includes/sys/types.h>
#include </usr/includes/sys/file.h>
#include </usr/includes/sys/time.h>
#include <net/pfilt.h>
